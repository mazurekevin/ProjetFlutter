...
// Widget previewWidget(BuildContext context, MoviePreview moviesPreview) {
//   bool isLiked = false;
//   Icon liked;
//   var releaseDate = DateFormat('d MMMM yyyy')
//       .format(DateTime.parse(moviesPreview.releaseDate));
//
//   return Container(
//       decoration: BoxDecoration(
//         borderRadius: BorderRadius.circular(10),
...
//                 ),
//                 child: Image.network(
//                   "https://image.tmdb.org/t/p/w500${moviesPreview.posterPath}",
//                 ),
//               ),
//               IconButton(
//                 onPressed: () =>
...
// //                   children: [
// //                     Text(
// //                       moviesPreview.voteAverage.toString(),
// //                       style: const TextStyle(
// //                         fontSize: 15,
// //                         fontWeight: FontWeight.bold,
// //                       ),
